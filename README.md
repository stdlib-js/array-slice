...
```javascript
import slice from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-slice@v0.2.3-esm/index.mjs';
```
...
[@stdlib/array/take]: https://github.com/stdlib-js/array-take/tree/esm
